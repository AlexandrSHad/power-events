...
- `esp32/` - Shows the laptop status using in-built RGB LED, this is experimental project do not count on it during analysis and implementation
- `windows-events-listener/` - sandbox project for testing the logic using CLI application insted of Windows Service, this is experimental project do not count on it during analysis and implementation
